...
public class ClaimfromRWC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_claimfrom_rwc );
        ...
        submitpmu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (HelperUtilities.isEmptyOrNull(designation.getText().toString())) {
                    ...
                    Global.diloge(ClaimfromRWC.this,"Error","Please select valid document");
                }
                else{
                    new ClaimfromRWC.UploadFileToServer().execute();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (jsonObject.getBoolean("status")){
                    Global.diloge(ClaimfromRWC.this,"Success","We have recorded your request");
                }
