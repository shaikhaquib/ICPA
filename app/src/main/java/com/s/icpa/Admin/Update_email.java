...
public class Update_email extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        disapprove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SendNotification(Update_email.this).execute(Global.customer_id,name.getText().toString()+"Email change request","your request for email change has been disapproved.For more information you can contact region admin" );
    ...
    private void getData() {
        ...
        newEmail.setText(data.getNewEmail());
        ...
        approve.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                approve_user(data.getNewEmail(),data.getCustomerId());
            }
        });
                ...
                try {
                    ...
                    if (jsonObject.getBoolean("status")) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            builder = new AlertDialog.Builder(Update_email.this, android.R.style.Theme_Material_Light_Dialog_Alert);
                        } else {
                            builder = new AlertDialog.Builder(Update_email.this);
                        }
                        builder.setCancelable(false);
                        builder.setTitle("Success")
                                .setMessage("You have updated user email id")
                                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();
                                        new SendNotification(Update_email.this).execute(Global.customer_id,name.getText().toString()+"Email change request","your request for email change has been approved.To apply setting you have to logout and re-login into your account" );
                                        startActivity(new Intent(Update_email.this, AdminActivity.class));
                                        finish();
                                    }
                                })
                        ...
                        Global.diloge(Update_email.this, "Error", jsonObject.getString("result"));
                    }
