    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                OrderInfo_new orderInfo = new OrderInfo_new();
                ...
                OrderInfo_new objOrderInfo = new OrderInfo_new();
                ...
                objOrderInfo.setSecure_hash(String.valueOf(sb));
                ...
                Intent i = new Intent(getApplicationContext(), PaymentProcessing_new.class);
